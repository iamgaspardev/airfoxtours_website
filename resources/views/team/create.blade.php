    ...
    <div class="container min-vh-100">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-9 text-center justify-content-center">
                <h3>Upload <span>Airfox Team Member</span> !</h3>
                <p>User can Explore the world with Airfox Tours - Please upload Team Members of Airfox Tours</p>
            </div>
            <div class="mb-3"></div>
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('team.store') }}" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary"
                                style="background-color: #007c9b; border-color: #007c9b; color: #fff;">
                                {{ __('Add Team Member') }}
                            </button>
