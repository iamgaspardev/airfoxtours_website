      ...
      <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg);">
        <div class="carousel-container">
          <div class="carousel-content animate__animated animate__fadeInUp">
            ...
            <p>Discover a world of seamless travel experiences with Airfox Tours. From expert Visa Processing to comfortable Car Rentals, we offer a comprehensive suite of services. Your adventure starts here!</p>
            <div class="text-center"><a href="#services" class="btn-get-started">Explore Our Services</a></div>
          </div>
        </div>
      </div>
      ...
      <div class="carousel-item" style="background-image: url(assets/img/slide/slide-2.jpg);">
        <div class="carousel-container">
          <div class="carousel-content animate__animated animate__fadeInUp">
            ...
            <p>Embark on worry-free journeys with Airfox Tours. Whether it's Visa Processing, Flight Booking, Car Rentals, Hotel Booking, Abroad Consultation, or Visa Documentation - we've got you covered. Your adventure begins now!</p>
            <div class="text-center"><a href="#services" class="btn-get-started">Start Your Journey</a></div>
          </div>
        </div>
      </div>
      ...
      <div class="carousel-item" style="background-image: url(assets/img/slide/slide-3.jpg);">
        <div class="carousel-container">
          <div class="carousel-content animate__animated animate__fadeInUp">
            ...
            <p>At Airfox Tours, we redefine travel excellence. Immerse yourself in the convenience of our services - Visa Processing, Flight Booking, Car Rentals, Hotel Booking, Abroad Consultation, and Visa Documentation. Let's make your journey extraordinary!</p>
            <div class="text-center"><a href="#services" class="btn-get-started">Plan Your Adventure</a></div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-9 text-center text-lg-left">
        ...
        <p>Explore the world with Airfox Tours - Your trusted partner for hassle-free visa processing, expert hotel management, and convenient car rentals in Dar es Salaam.</p>
      </div>
