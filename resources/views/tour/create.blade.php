            ...
            <div class="container justify-content-center">
                ...
                <div class="row mt-8 justify-content-center" data-aos="fade-up">
                    <div class="col-lg-9 text-center justify-content-center">
                        <h3>Airfox Tours <span>Admin Panels</span> !</h3>
                        <p>User can Explore the world with Airfox Tours - Please upload Tours to be seen by clients by
                            ...
                            <div class="card-body">
                                <form action="{{ route('tour.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" class="btn btn-primary"
                                        style="background-color: #007c9b; border-color: #007c9b; color: #fff;">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
