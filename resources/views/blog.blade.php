            ...
            <div class="sidebar">
              ...
              @foreach ($tours as $tour)
                <div class="post-item clearfix">
                  <img src="{{ asset('uploads/' . $tour->image) }}" style="height: 60px; object-fit: cover;" alt="{{ $tour->title }}">
                  <h4><a href="{{ route('consultationform', ['image' => basename($tour->image)]) }}">{{ $tour->title }}</a></h4>
